...
{
    class X509SerialNumberXML
    {
        private string _prefix;
        private string _localName;
        private string _namesSpaceUri;

        public X509SerialNumberXML(string prefix = null, string localName = null, string namesSpaceURI = null)
        {
            _prefix = String.IsNullOrEmpty(prefix) ? "o" : prefix;
            _localName = string.IsNullOrEmpty(localName) ? "X509SerialNumber" : localName;
