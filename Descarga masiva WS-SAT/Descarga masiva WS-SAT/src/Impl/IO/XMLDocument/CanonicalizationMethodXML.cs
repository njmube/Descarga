...
namespace WSDescargaMasivaSAT.Impl.IO.XMLDocument
{
    public class CanonicalizationMethodXML
    {
        ...
        public CanonicalizationMethodXML(string prefix = null, string localName = null, string namesSpaceURI = null)
        {
            _prefix = String.IsNullOrEmpty(prefix) ? "o" : prefix;
            _localName = string.IsNullOrEmpty(localName) ? "CanonicalizationMethod" : localName;
