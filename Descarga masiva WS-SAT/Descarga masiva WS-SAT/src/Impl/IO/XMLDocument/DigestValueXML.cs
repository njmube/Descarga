...
namespace WSDescargaMasivaSAT.Impl.IO.XMLDocument
{
    class DigestValueXML
    {
        ...
        public DigestValueXML(string prefix = null, string localName = null, string namesSpaceURI = null)
        {
            _prefix = String.IsNullOrEmpty(prefix) ? "o" : prefix;
            _localName = string.IsNullOrEmpty(localName) ? "DigestValue" : localName;
