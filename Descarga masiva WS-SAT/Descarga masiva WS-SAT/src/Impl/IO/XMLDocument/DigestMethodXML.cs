...
namespace WSDescargaMasivaSAT.Impl.IO.XMLDocument
{
    public class DigestMethodXML
    {
        ...
        public DigestMethodXML(string prefix = null, string localName = null, string namesSpaceURI = null)
        {
            _prefix = String.IsNullOrEmpty(prefix) ? "o" : prefix;
            _localName = string.IsNullOrEmpty(localName) ? "DigestMethod" : localName;
        ...
        {
            securityElement.SetAttribute("Algorithm", "http://www.w3.org/2000/09/xmldsig#sha1");
