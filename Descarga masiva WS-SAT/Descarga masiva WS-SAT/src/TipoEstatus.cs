...
namespace Descarga_masiva_WS_SAT.src
{
    ...
    public class TipoEstatus
    {
        ...
        /// - descripción
        /// </summary>
        /// <param name="clave">La clave del estatus</param>
        /// <param name="nombre">nombre que del estatus</param>
        /// <param name="descripcion">descripción del estatus, puede ser opcional</param>
